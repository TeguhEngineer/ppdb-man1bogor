                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div class="border-2 border-dashed border-gray-300 p-4 rounded-lg text-center bg-gray-50">
                                    ...
                                    <input type="file" name="kartu_keluarga" accept=".pdf,image/*" class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-white file:text-gray-700 hover:file:bg-gray-100" required>
                                </div>
                                        <div class="border-2 border-dashed border-gray-300 p-4 rounded-lg text-center bg-gray-50">
                                            <label class="block text-sm font-medium text-gray-700 mb-2">Slip Gaji Orang Tua <span class="text-red-500">*</span></label>
                                            <input type="file" name="slip_gaji" accept=".pdf,image/*" class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-white file:text-gray-700 hover:file:bg-gray-100" required>
                                        </div>
                                        <div class="border-2 border-dashed border-gray-300 p-4 rounded-lg text-center bg-gray-50">
