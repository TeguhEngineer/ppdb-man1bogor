...
class PengaturanSistemController extends Controller
{
    ...
    public function updateSkl(Request $request)
    {
        $data = $request->validate([
            ...
            'skl_agenda_tanggal.max' => 'Hari dan tanggal kegiatan maksimal 20 karakter.',
            'skl_agenda_waktu.required' => 'Waktu kegiatan wajib diisi.',
            'skl_agenda_waktu.max' => 'Waktu kegiatan maksimal 13 karakter.',
            'skl_agenda_tempat.required' => 'Tempat kegiatan wajib diisi.',
            'skl_agenda_tempat.max' => 'Tempat kegiatan maksimal 11 karakter.',
            'skl_agenda_keperluan.required' => 'Keperluan kegiatan wajib diisi.',
            'skl_agenda_keperluan.max' => 'Keperluan kegiatan maksimal 42 karakter.',
            'skl_ttd_tempat_tanggal.required' => 'Tempat dan tanggal tanda tangan wajib diisi.',
            'skl_ttd_tempat_tanggal.max' => 'Tempat dan tanggal tanda tangan maksimal 20 karakter.',
            'skl_ketua_panitia.required' => 'Nama ketua panitia wajib diisi.',
            'skl_ketua_panitia.max' => 'Nama ketua panitia maksimal 22 karakter.',
            'skl_nip_ketua_panitia.required' => 'NIP ketua panitia wajib diisi.',
            'skl_nip_ketua_panitia.max' => 'NIP ketua panitia maksimal 18 karakter.',
